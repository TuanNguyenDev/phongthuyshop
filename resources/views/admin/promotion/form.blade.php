...
<div class="col-sm-12">
	<form action="{{route('promotion.save')}}" method="post" accept-charset="utf-8" novalidate>
		...
		<div class="form-group">
			...
			<input type="number" min="1" max="70" value="{{old('chiet_khau',$model->chiet_khau)}}" name="chiet_khau" id="chiet_khau" class="form-control"  placeholder="Phần trăm triết khấu">
		</div>
