...
@section('title', 'Thông tin sản phẩm bán chạy')
@section('config_title', 'Thông tin sản phẩm bán chạy')
@section('content')
<div class="text-center">
	<h3>Nhập ngày bắt đầu và kết thúc để xem thông tin sản phẩm bán chạy</h3>
</div>
<form action="{{route('top.product.manual')}}" method="post" accept-charset="utf-8" novalidate>
	{{csrf_field()}}
