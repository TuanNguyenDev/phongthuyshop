				...
				<div class="container">
					<div class="row">
						<div class="collection-wrapper">
							<h1 class="collection-title"><span>{{get_menh_name($id_menh)}}</span></h1>
								...
								<div class="breadcrumb clearfix">
									...
									<span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
										<a href="#" title="Products" itemprop="url">
											<span itemprop="title">{{get_menh_name($id_menh)}}</span>
										</a>
									</span>
								</div>
							</div>
							...
							<div class="row">
								<div class="collection-colpro-inner">
									<div class="collection-colpro-content">
										<span class="colpro_title">Có {{count($count)}} sản phẩm trong mệnh này</span>
