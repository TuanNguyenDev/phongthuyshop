	...
	<div class="page-container" id="PageContainer">
		<main class="main-content" id="MainContent" role="main">
			<section class="collection-heading heading-content ">
				<a href="">
					<img class="img_heading" src="./assets/images/demo_1920×214.png" alt="">
				</a>
				<div class="container">
					<div class="row">
													...
													<div class="ra-item-inner">
														<div class="article clearfix">
															<div class="article-image">
																<a href="./article.html"><img src="./assets/images/demo_96×56.png" alt=""></a>
															</div>
										...
										<div class="col-sm-9 articles">
											<div class="blog-top">
												<div class="top-left">
													<div class="article clearfix  blog_Grid">
														<div class="article-image">
															<a href="./article.html"><img src="./assets/images/demo_395×228.png" alt=""></a>
														</div>
														<div class="articleinfo_group">
															<div class="article-title">
												...
												<div class="top-right">
													<div class="article clearfix">
														<div class="article-image">
															<a href="./article.html"><img src="./assets/images/demo_146×85.png" alt=""></a>
														</div>
														<div class="articleinfo_group">
															<div class="article-title">
											...
											<div class="blog-items">
												<div class="article clearfix col-sm-6 blog_Grid">
													<div class="article-image">
														<a href="./article.html"><img src="./assets/images/demo_400×231.png" alt=""></a>
													</div>
													<div class="articleinfo_group">
														<div class="article-title">
